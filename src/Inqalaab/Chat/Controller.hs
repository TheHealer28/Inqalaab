...
module Inqalaab.Chat.Controller where
...
import qualified Paths_inqalaab as SC
import Inqalaab.Chat.AppSettings
...
import Inqalaab.Chat.Remote.AppVersion
import Inqalaab.Chat.Remote.Types
import Inqalaab.Chat.Stats (PresentedServersSummary)
import Inqalaab.Chat.Store (AddressSettings, ChatLockEntity, GroupLink, GroupLinkInfo, StoreError (..), UserContactLink, UserMsgReceiptSettings)
...
import Inqalaab.Chat.Util (liftIOEither)
...
versionString ver = "Inqalaab v" <> ver

updateStr :: String
updateStr = "Update through App Store or TestFlight."

inqalbimqCommitQ :: Q Exp
inqalbimqCommitQ = do
...
coreVersionInfo inqalbimqCommit =
  CoreVersionInfo
    { version = versionNumber,
      inqalbimqVersion = simplexMQVersion,
      inqalbimqCommit
    }
...
data CoreVersionInfo = CoreVersionInfo
  { version :: String,
    inqalbimqVersion :: String,
    inqalbimqCommit :: String
  }
  deriving (Show)
