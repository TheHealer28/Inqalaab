...
module Inqalaab.Chat.Library.Internal where
...
import Inqalaab.Chat.Call
import Inqalaab.Chat.Controller
import Inqalaab.Chat.Files
import Inqalaab.Chat.Markdown
import Inqalaab.Chat.Messages
import Inqalaab.Chat.Messages.Batch (MsgBatch (..), batchMessages)
import Inqalaab.Chat.Messages.CIContent
import Inqalaab.Chat.Messages.CIContent.Events
import Inqalaab.Chat.Operators
import Inqalaab.Chat.ProfileGenerator (generateRandomProfile)
import Inqalaab.Chat.Protocol
import Inqalaab.Chat.Store
import Inqalaab.Chat.Store.ContactRequest
import Inqalaab.Chat.Store.Direct
import Inqalaab.Chat.Store.Files
import Inqalaab.Chat.Store.Groups
import Inqalaab.Chat.Store.Messages
import Inqalaab.Chat.Store.Profiles
import Inqalaab.Chat.Store.Shared
import Inqalaab.Chat.Types
import Inqalaab.Chat.Types.Preferences
import Inqalaab.Chat.Types.Shared
import Inqalaab.Chat.Util (encryptFile, shuffle)
...
adminContactReq =
  either error id . strDecode . B.concat $
    [ "sim",
      "plex:/contact#/?v=1&smp=smp%3A%2F%2FPQUV2eL0t7OStZOoAsPEV2QYWt4-xilbakvGUGOItUo%3D%40smp",
      "6.",
      "sim",
      "plex",
      ".im%2FK1rslx-m5bpXVIdMZg9NLUZ_8JBm8xTt%23MCowBQYDK2VuAyEALDeVe-sG8mRY22LsXlPgiwTNs9dbiLrNuA7f3ZMAJ2w%3D"
    ]

inqalaabSupportContactProfile :: Profile
inqalaabSupportContactProfile =
  Profile
    { displayName = "Inqalaab Support",
      fullName = "",
      shortDescr = Just "Send questions about the Inqalaab app and your suggestions",
...
inqalaabStatusContactProfile :: Profile
inqalaabStatusContactProfile =
  Profile
    { displayName = "Inqalaab Status",
      fullName = "",
      ...
      contactLink = Just . either error CLFull . strDecode . B.concat $
        [ "sim",
          "plex:/contact/#/?v=1-2&smp=smp%3A%2F%2Fu2dS9sG8nMNURyZwqASV4yROM28Er0luVTx5X1CsMrU%3D%40smp",
          "4.",
          "sim",
          "plex",
          ".im%2FShQuD-rPokbDvkyotKx5NwM8P3oUXHxA%23%2F%3Fv%3D1-2%26dh%3DMCowBQYDK2VuAyEA6fSx1k9zrOmF0BJpCaTarZvnZpMTAVQhd3RkDQ35KT0%253D%26srv%3Do5vmywmrnaxalvz6wi3zicyftgio6psuvyniis6gco6bp6ekl4cqj4id.onion"
        ],
