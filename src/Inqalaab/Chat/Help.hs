...
import Inqalaab.Chat.Types (LocalProfile (..), User (..))
...
chatWelcome user =
  map
    ...
    [ "                             __   __",
      ...
      "Thank you for installing Inqalaab!",
      "",
      "Connect to Inqalaab support for any questions - just type " <> highlight "/support",
      "",
      "Project:",
      "> https://github.com/TheHealer28/Inqalaab",
      "",
...
chatHelpInfo =
  map
    ...
    [ highlight "Using Inqalaab",
      ...
      indent <> highlight "/version         " <> " - Inqalaab version",
...
incognitoHelpInfo =
  map
    ...
    [ markdown (colored Red) "/incognito" <> " command is deprecated, use commands below instead.",
      ...
      indent <> highlight "/support incognito               " <> " - connect to Inqalaab support using incognito profile",
      "",
