...
module Inqalaab.Chat.Store.SQLite.Migrations (migrations) where

import Data.List (sortOn)
import Database.SQLite.Simple (Query (..))
import Inqalaab.Chat.Store.SQLite.Migrations.M20220101_initial
import Inqalaab.Chat.Store.SQLite.Migrations.M20220122_v1_1
import Inqalaab.Chat.Store.SQLite.Migrations.M20220205_chat_item_status
import Inqalaab.Chat.Store.SQLite.Migrations.M20220210_deduplicate_contact_requests
import Inqalaab.Chat.Store.SQLite.Migrations.M20220224_messages_fks
import Inqalaab.Chat.Store.SQLite.Migrations.M20220301_smp_servers
import Inqalaab.Chat.Store.SQLite.Migrations.M20220302_profile_images
import Inqalaab.Chat.Store.SQLite.Migrations.M20220304_msg_quotes
import Inqalaab.Chat.Store.SQLite.Migrations.M20220321_chat_item_edited
import Inqalaab.Chat.Store.SQLite.Migrations.M20220404_files_status_fields
import Inqalaab.Chat.Store.SQLite.Migrations.M20220514_profiles_user_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20220626_auto_reply
import Inqalaab.Chat.Store.SQLite.Migrations.M20220702_calls
import Inqalaab.Chat.Store.SQLite.Migrations.M20220715_groups_chat_item_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20220811_chat_items_indices
import Inqalaab.Chat.Store.SQLite.Migrations.M20220812_incognito_profiles
import Inqalaab.Chat.Store.SQLite.Migrations.M20220818_chat_notifications
import Inqalaab.Chat.Store.SQLite.Migrations.M20220822_groups_host_conn_custom_user_profile_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20220823_delete_broken_group_event_chat_items
import Inqalaab.Chat.Store.SQLite.Migrations.M20220824_profiles_local_alias
import Inqalaab.Chat.Store.SQLite.Migrations.M20220909_commands
import Inqalaab.Chat.Store.SQLite.Migrations.M20220926_connection_alias
import Inqalaab.Chat.Store.SQLite.Migrations.M20220928_settings
import Inqalaab.Chat.Store.SQLite.Migrations.M20221001_shared_msg_id_indices
import Inqalaab.Chat.Store.SQLite.Migrations.M20221003_delete_broken_integrity_error_chat_items
import Inqalaab.Chat.Store.SQLite.Migrations.M20221004_idx_msg_deliveries_message_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20221011_user_contact_links_group_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20221012_inline_files
import Inqalaab.Chat.Store.SQLite.Migrations.M20221019_unread_chat
import Inqalaab.Chat.Store.SQLite.Migrations.M20221021_auto_accept__group_links
import Inqalaab.Chat.Store.SQLite.Migrations.M20221024_contact_used
import Inqalaab.Chat.Store.SQLite.Migrations.M20221025_chat_settings
import Inqalaab.Chat.Store.SQLite.Migrations.M20221029_group_link_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20221112_server_password
import Inqalaab.Chat.Store.SQLite.Migrations.M20221115_server_cfg
import Inqalaab.Chat.Store.SQLite.Migrations.M20221129_delete_group_feature_items
import Inqalaab.Chat.Store.SQLite.Migrations.M20221130_delete_item_deleted
import Inqalaab.Chat.Store.SQLite.Migrations.M20221209_verified_connection
import Inqalaab.Chat.Store.SQLite.Migrations.M20221210_idxs
import Inqalaab.Chat.Store.SQLite.Migrations.M20221211_group_description
import Inqalaab.Chat.Store.SQLite.Migrations.M20221212_chat_items_timed
import Inqalaab.Chat.Store.SQLite.Migrations.M20221214_live_message
import Inqalaab.Chat.Store.SQLite.Migrations.M20221222_chat_ts
import Inqalaab.Chat.Store.SQLite.Migrations.M20221223_idx_chat_items_item_status
import Inqalaab.Chat.Store.SQLite.Migrations.M20221230_idxs
import Inqalaab.Chat.Store.SQLite.Migrations.M20230107_connections_auth_err_counter
import Inqalaab.Chat.Store.SQLite.Migrations.M20230111_users_agent_user_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20230117_fkey_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20230118_recreate_smp_servers
import Inqalaab.Chat.Store.SQLite.Migrations.M20230129_drop_chat_items_group_idx
import Inqalaab.Chat.Store.SQLite.Migrations.M20230206_item_deleted_by_group_member_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20230303_group_link_role
import Inqalaab.Chat.Store.SQLite.Migrations.M20230317_hidden_profiles
import Inqalaab.Chat.Store.SQLite.Migrations.M20230318_file_description
import Inqalaab.Chat.Store.SQLite.Migrations.M20230321_agent_file_deleted
import Inqalaab.Chat.Store.SQLite.Migrations.M20230328_files_protocol
import Inqalaab.Chat.Store.SQLite.Migrations.M20230402_protocol_servers
import Inqalaab.Chat.Store.SQLite.Migrations.M20230411_extra_xftp_file_descriptions
import Inqalaab.Chat.Store.SQLite.Migrations.M20230420_rcv_files_to_receive
import Inqalaab.Chat.Store.SQLite.Migrations.M20230422_profile_contact_links
import Inqalaab.Chat.Store.SQLite.Migrations.M20230504_recreate_msg_delivery_events_cleanup_messages
import Inqalaab.Chat.Store.SQLite.Migrations.M20230505_chat_item_versions
import Inqalaab.Chat.Store.SQLite.Migrations.M20230511_reactions
import Inqalaab.Chat.Store.SQLite.Migrations.M20230519_item_deleted_ts
import Inqalaab.Chat.Store.SQLite.Migrations.M20230526_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20230529_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20230608_deleted_contacts
import Inqalaab.Chat.Store.SQLite.Migrations.M20230618_favorite_chats
import Inqalaab.Chat.Store.SQLite.Migrations.M20230621_chat_item_moderations
import Inqalaab.Chat.Store.SQLite.Migrations.M20230705_delivery_receipts
import Inqalaab.Chat.Store.SQLite.Migrations.M20230721_group_snd_item_statuses
import Inqalaab.Chat.Store.SQLite.Migrations.M20230814_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20230827_file_encryption
import Inqalaab.Chat.Store.SQLite.Migrations.M20230829_connections_chat_vrange
import Inqalaab.Chat.Store.SQLite.Migrations.M20230903_connections_to_subscribe
import Inqalaab.Chat.Store.SQLite.Migrations.M20230913_member_contacts
import Inqalaab.Chat.Store.SQLite.Migrations.M20230914_member_probes
import Inqalaab.Chat.Store.SQLite.Migrations.M20230926_contact_status
import Inqalaab.Chat.Store.SQLite.Migrations.M20231002_conn_initiated
import Inqalaab.Chat.Store.SQLite.Migrations.M20231009_via_group_link_uri_hash
import Inqalaab.Chat.Store.SQLite.Migrations.M20231010_member_settings
import Inqalaab.Chat.Store.SQLite.Migrations.M20231019_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20231030_xgrplinkmem_received
import Inqalaab.Chat.Store.SQLite.Migrations.M20231107_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20231113_group_forward
import Inqalaab.Chat.Store.SQLite.Migrations.M20231114_remote_control
import Inqalaab.Chat.Store.SQLite.Migrations.M20231126_remote_ctrl_address
import Inqalaab.Chat.Store.SQLite.Migrations.M20231207_chat_list_pagination
import Inqalaab.Chat.Store.SQLite.Migrations.M20231214_item_content_tag
import Inqalaab.Chat.Store.SQLite.Migrations.M20231215_recreate_msg_deliveries
import Inqalaab.Chat.Store.SQLite.Migrations.M20240102_note_folders
import Inqalaab.Chat.Store.SQLite.Migrations.M20240104_members_profile_update
import Inqalaab.Chat.Store.SQLite.Migrations.M20240115_block_member_for_all
import Inqalaab.Chat.Store.SQLite.Migrations.M20240122_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20240214_redirect_file_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20240222_app_settings
import Inqalaab.Chat.Store.SQLite.Migrations.M20240226_users_restrict
import Inqalaab.Chat.Store.SQLite.Migrations.M20240228_pq
import Inqalaab.Chat.Store.SQLite.Migrations.M20240313_drop_agent_ack_cmd_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20240324_custom_data
import Inqalaab.Chat.Store.SQLite.Migrations.M20240402_item_forwarded
import Inqalaab.Chat.Store.SQLite.Migrations.M20240430_ui_theme
import Inqalaab.Chat.Store.SQLite.Migrations.M20240501_chat_deleted
import Inqalaab.Chat.Store.SQLite.Migrations.M20240510_chat_items_via_proxy
import Inqalaab.Chat.Store.SQLite.Migrations.M20240515_rcv_files_user_approved_relays
import Inqalaab.Chat.Store.SQLite.Migrations.M20240528_quota_err_counter
import Inqalaab.Chat.Store.SQLite.Migrations.M20240827_calls_uuid
import Inqalaab.Chat.Store.SQLite.Migrations.M20240920_user_order
import Inqalaab.Chat.Store.SQLite.Migrations.M20241008_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20241010_contact_requests_contact_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20241023_chat_item_autoincrement_id
import Inqalaab.Chat.Store.SQLite.Migrations.M20241027_server_operators
import Inqalaab.Chat.Store.SQLite.Migrations.M20241125_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20241128_business_chats
import Inqalaab.Chat.Store.SQLite.Migrations.M20241205_business_chat_members
import Inqalaab.Chat.Store.SQLite.Migrations.M20241222_operator_conditions
import Inqalaab.Chat.Store.SQLite.Migrations.M20241223_chat_tags
import Inqalaab.Chat.Store.SQLite.Migrations.M20241230_reports
import Inqalaab.Chat.Store.SQLite.Migrations.M20250105_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20250115_chat_ttl
import Inqalaab.Chat.Store.SQLite.Migrations.M20250122_chat_items_include_in_history
import Inqalaab.Chat.Store.SQLite.Migrations.M20250126_mentions
import Inqalaab.Chat.Store.SQLite.Migrations.M20250129_delete_unused_contacts
import Inqalaab.Chat.Store.SQLite.Migrations.M20250130_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20250402_short_links
import Inqalaab.Chat.Store.SQLite.Migrations.M20250512_member_admission
import Inqalaab.Chat.Store.SQLite.Migrations.M20250513_group_scope
import Inqalaab.Chat.Store.SQLite.Migrations.M20250526_short_links
import Inqalaab.Chat.Store.SQLite.Migrations.M20250702_contact_requests_remove_cascade_delete
import Inqalaab.Chat.Store.SQLite.Migrations.M20250704_groups_conn_link_prepared_connection
import Inqalaab.Chat.Store.SQLite.Migrations.M20250709_profile_short_descr
import Inqalaab.Chat.Store.SQLite.Migrations.M20250721_indexes
import Inqalaab.Chat.Store.SQLite.Migrations.M20250729_member_contact_requests
import Inqalaab.Chat.Store.SQLite.Migrations.M20250801_via_group_link_uri
import Inqalaab.Chat.Store.SQLite.Migrations.M20250802_chat_peer_type
