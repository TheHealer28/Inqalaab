...
module Inqalaab.Chat.Store.Postgres.Migrations (migrations) where

import Data.List (sortOn)
import Data.Text (Text)
import Inqalaab.Chat.Store.Postgres.Migrations.M20241220_initial
import Inqalaab.Chat.Store.Postgres.Migrations.M20250402_short_links
import Inqalaab.Chat.Store.Postgres.Migrations.M20250512_member_admission
import Inqalaab.Chat.Store.Postgres.Migrations.M20250513_group_scope
import Inqalaab.Chat.Store.Postgres.Migrations.M20250526_short_links
import Inqalaab.Chat.Store.Postgres.Migrations.M20250702_contact_requests_remove_cascade_delete
import Inqalaab.Chat.Store.Postgres.Migrations.M20250704_groups_conn_link_prepared_connection
import Inqalaab.Chat.Store.Postgres.Migrations.M20250709_profile_short_descr
import Inqalaab.Chat.Store.Postgres.Migrations.M20250721_indexes
import Inqalaab.Chat.Store.Postgres.Migrations.M20250729_member_contact_requests
import Inqalaab.Chat.Store.Postgres.Migrations.M20250801_via_group_link_uri
import Inqalaab.Chat.Store.Postgres.Migrations.M20250802_chat_peer_type
